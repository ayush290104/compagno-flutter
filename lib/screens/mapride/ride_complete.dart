      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Text("R i d e  c o m p l e t e",style: k32_400_bebas,),
          ),
          SizedBox(height: 190,),
          InkWell(
            onTap: (){
          ...
          SizedBox(height: 20,),
          Text("GREAT WORK!",style: k13_700_roboto,),
          SizedBox(height: 40,),
          Text("Your ride data will be available on the ",style: k13_400_roboto,),
          Text.rich(
            TextSpan(
              children: [
