                                  ...
                                  showDialog(
                                      ...
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          ...
                                          content: Text('Are you sure you want to proceed?'), // Your description here
                                          actions: <Widget>[
                                            TextButton(
                                              child: Text('No'),
                                              onPressed: () {
                                                Navigator.of(context).pop(false); // Returning false if "No" is selected
                                              },
                                            ),
                                            TextButton(
                                              child: Text('Yes'),
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            onChanged: (value) {
                              ...
                              modifyController.userDataMap.value['name'] = value;
                            },
                            validator: (value) {
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: TextFormField(
                                        ...
                                        onChanged: (value) {
                                          modifyController.user.value.email =
                                              value;

                                          modifyController
                                              .userDataMap.value['email'] = value;
                                        },
                                        decoration: InputDecoration(
                                            border: InputBorder.none,
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: TextFormField(
                                        ...
                                        onChanged: (value) {
                                          modifyController.user.value.phone =
                                              value;
                                          modifyController
                                              .userDataMap.value['phone'] = value;
                                        },
                                        inputFormatters: [
