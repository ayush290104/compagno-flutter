...
class _AwardsState extends State<Awards> {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [BlocProvider.value(value: awardsCubit)],
      child: Scaffold(
                    ...
                    children: [
                      ...
                      BlocBuilder<AwardsCubit, AwardsState>(
                        ...
                        if (awardsCubit.award!.awardsProgress.isEmpty)
                          return Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text("nothing yet , go do some training!",
                                style: TextStyle(color: Colors.white)),
                          );
                        ...
                        return Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            for (AwardsProgress progress
                                in awardsCubit.award!.awardsProgress)
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Row(
