...
class RouteGenerator {
  ...
  Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name){
      ...
      case goalComplete:
        return MaterialPageRoute(builder: (context) => GoalSetChatterComplete());
      case goalChatter2:
        return MaterialPageRoute(builder: (context)=> GoalSetLargerChatterStep2());
      case goalChatter:
      ...
      case lessonCompleted:
        return MaterialPageRoute(builder: (context) => LessonCompleted());
      case training:
        return MaterialPageRoute(builder: (context)=> Training());
      case trainingLesson:
        return MaterialPageRoute(builder: (context) => TrainingLesson());
      case styleguide:
